...
GLuint generateObjectBuffer(GLfloat vertices[], GLfloat colors[]) {
	...
	glBufferData(GL_ARRAY_BUFFER, numVertices*7*sizeof(GLfloat), vertices, GL_STATIC_DRAW);
...
// VAO Functions - click on + to expand
...
GLuint generateObjectArray(GLfloat vertices[], GLfloat colors[]) {
	...
	glBindBuffer(GL_ARRAY_BUFFER, generateObjectBuffer(vertices,colors));
